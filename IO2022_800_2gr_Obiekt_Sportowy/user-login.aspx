<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="user-login.aspx.cs" Inherits="projekt_obiekt.user_login" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100vw" src="img/generaluser.png" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <center>
                                    <h3 class="login-h3">Logowanie</h3>
                                </center>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <a href="user-register.aspx">
                                            <input class="btn btn-info btn-block btn-lg" id="Button2" type="button" value="Zarejestruj się" /></a>
                                    </div>
                                </div>
                            </div>
